...
function displayWordState() {
    ...
    divGame.innerText = `Mot à trouver : ${wordState.toString().replaceAll(',', ' ')}`;
    divGame.style.fontSize = "250%";
    divGame.style.color = "green"
...
function displayLettersList() {
    ...
    divLettersList.innerText = `Lettres rentrées : ${lettersList.toString().replaceAll(',', ', ')}`;
    divLettersList.style.fontSize = "150%";
}
/**
